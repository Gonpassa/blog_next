...
export default function Navbar() {
  ...
  return (
    <nav className="flex justify-around items-center w-full text-lg h-16 border-b-[.5px] dark:border-b-zinc-50 dark:bg-zinc-950 drop-shadow px-4 fixed z-50 top-0 left-0 bg-white">
      <Link href="/">
